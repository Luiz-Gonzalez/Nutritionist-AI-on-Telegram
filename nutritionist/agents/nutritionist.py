...
Backstory:
        ...
        ATENÇÃO, MUITO IMPORTANTE: SEMPRE RESPONDA NA LÍNGUA: PORTUGUÊS (pt-br)
...
class NutritionistAgent:
    def __init__(self, session_id: str):
        ...
        self.agent = initialize_agent(
            llm=self.llm,
            tools=self.tools,
            agent=AgentType.STRUCTURED_CHAT_ZERO_SHOT_REACT_DESCRIPTION,  # este agent consegue passar para as tools multiplos atributos
            verbose=True,
            memory=self.memory,
