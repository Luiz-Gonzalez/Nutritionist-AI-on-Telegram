...
import logging  # registra os logs
import asyncio
import os
from pyrogram import Client, filters  # client: autorização
...
class TelegramBot:
    def __init__(self):
        ...
        self.app = Client(
            ...
            name="luiz84_nutritionist_ai_bot",
        )
    ...
    async def start(self, client: Client, message: Message):
        await message.reply_text(
            "Olá! Eu sou sua IA Nutricionista. Envie uma mensagem ou a foto de um prato de comida para começar."
        )
